...
from yololite.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from yololite.utils.metrics import DetMetrics
...
def _create_experiment(args):
    ...
    try:
        ...
        experiment.log_other("Created from", "yololite")
...
def on_fit_epoch_end(trainer):
    ...
    if curr_epoch == 1:
        from yololite.utils.torch_utils import model_info_for_loggers
