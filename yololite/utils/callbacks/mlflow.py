...
from yololite.utils import LOGGER, RUNS_DIR, SETTINGS, TESTS_RUNNING, colorstr
...
def on_pretrain_routine_end(trainer):
    ...
    Args:
        trainer (yololite.engine.trainer.BaseTrainer): The training object with arguments and parameters to log.
