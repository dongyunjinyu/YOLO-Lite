...
from yololite.utils.autobatch import check_train_batch_size
...
class DetectionTrainer:
    ...
    def train(self):
        ...
        if world_size > 1 and "LOCAL_RANK" not in os.environ:
            LOGGER.warning("WARNING ⚠️ DDP is not available.")
    ...
    def _setup_train(self, world_size):
        ...
        if self.amp and RANK in {-1, 0}:  # Single-GPU and DDP
            ...
            # self.amp = torch.tensor(self.model, device=self.device)
